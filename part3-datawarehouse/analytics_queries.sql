...
-- Business Scenario:
-- "Marketing wants to target high-value customers. Segment customers
-- into High Value (>₹50,000), Medium Value (₹20,000–₹50,000),
-- and Low Value (<₹20,000). Show count of customers and revenue
-- in each segment."
